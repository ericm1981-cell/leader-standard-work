...
const WRONG_LEVEL = {
  ...
  "Team Member":{
    ...
    es:["Tomar decisiones de programación o disposición de calidad","Cubrir el rol de otra persona sin entrenamiento","Resolver problemas de equipo que requieren mantenimiento","Trabajar sin un estándar claro a seguir","Asistir a reuniones que no son relevantes para tu trabajo"]
  }
};
...
const ES_TEXTS = {
  "t1":"Dirigir reunión matutina — revisar KPIs",
  "t2":"Comunicar Preparación de Arranque — Personas, Equipo, Partes",
  "t3":"Reporte Spin revisado y comunicado",
  "t4":"Verificaciones Críticas de Calidad — Pre-Descanso, Pre/Post Almuerzo",
  ...
  "t8":"Acciones de Asistencia realizadas según necesidad",
  ...
  "t12":"Jeff Circle (Círculo Ohno) — observación estructurada completada para cada TL",
  "t13":"Racks de Etiqueta Roja — todo etiquetado y marcado",
  "t14":"Retrabajos de Marco/Sash ingresados en rastreador (Código QR)",
  "t15":"Tablero KPI actualizado con información diaria",
  "t16":"Órdenes Pendientes revisadas — todas accionadas",
...
const MANAGER_TEMPLATE = [
  {id:"m1",text:"Tier 2 / Tier 3 meeting — review department KPIs and escalations",freq:"Daily",timeOfDay:"Shift Start",duration:"20",owner:"Manager",standard:"Supervisors present data. Manager asks why, not what. Escalations have owners and dates.",auditTier:[],timeBin:"Start of Shift"},
  {id:"m2",text:"Gemba walk — observe supervisors executing standard work (not results)",freq:"Daily",timeOfDay:"",duration:"30",owner:"Manager",standard:"At least 1 supervisor observed per day. Coaching notes documented. Not a firefighting walk.",auditTier:[],timeBin:"Morning"},
  {id:"m3",text:"Layered audit — verify supervisor LSW completion",freq:"Daily",timeOfDay:"",duration:"20",owner:"Manager",standard:"Supervisor LSW signed off. Non-conformances logged with coaching follow-up within 24hrs.",auditTier:[],timeBin:"Morning"},
  {id:"m4",text:"Problem solving review — verify A3s / 5-whys are progressing, not stalled",freq:"Daily",timeOfDay:"",duration:"20",owner:"Manager",standard:"Every open A3 has an owner, a next action, and a due date. Nothing stalled >3 days without escalation.",auditTier:[],timeBin:"Mid-Shift"},
  {id:"m5",text:"Supervisor 1:1 coaching — development conversation (not firefighting debrief)",freq:"Weekly",dayOfWeek:"Wednesday",timeOfDay:"",duration:"45",owner:"Manager",standard:"Coaching against development plan, not daily issues. Supervisor owns the agenda. Manager asks questions.",auditTier:[],timeBin:"Weekly"},
  {id:"m6",text:"KPI trend review — week over week, identify patterns not just daily misses",freq:"Weekly",dayOfWeek:"Monday",timeOfDay:"",duration:"30",owner:"Manager",standard:"Trend analysis, not point-in-time. Identify systemic issues. Action items have owners.",auditTier:[],timeBin:"Weekly"},
  {id:"m7",text:"Safety audit — verify corrective actions closed from prior week",freq:"Weekly",dayOfWeek:"Friday",timeOfDay:"",duration:"20",owner:"Manager",standard:"All prior week safety actions verified closed or escalated. No aging open items.",auditTier:[],timeBin:"Weekly"},
  {id:"m8",text:"Capacity / staffing review — next week readiness",freq:"Weekly",dayOfWeek:"Thursday",timeOfDay:"",duration:"20",owner:"Manager",standard:"People, equipment, materials confirmed for next week. Gaps identified and actioned before Friday.",auditTier:[],timeBin:"Weekly"},
];

// ─── TEAM LEADER TEMPLATE ──────────────────────────────────────
const TL_TEMPLATE = [
  {id:"tl1",text:"Pre-shift check — People, Parts, Equipment confirmed before production starts",freq:"Each Shift",timeOfDay:"Shift Start",duration:"10",owner:"Team Leader",standard:"All 3 elements confirmed. Any gap escalated to Supervisor before line starts. No surprises.",auditTier:["Supervisor"],timeBin:"Start of Shift"},
  {id:"tl2",text:"Team member assignment — roles communicated to each person",freq:"Each Shift",timeOfDay:"Shift Start",duration:"5",owner:"Team Leader",standard:"Every team member knows their station and daily target before production starts.",auditTier:["Supervisor"],timeBin:"Start of Shift"},
  {id:"tl3",text:"Hourly production check — actual vs. target, log misses immediately",freq:"Each Shift",timeOfDay:"",duration:"5",owner:"Team Leader",standard:"HPR board updated every hour. Misses logged with reason code in real time — not end of shift.",auditTier:["Supervisor"],timeBin:"Morning"},
  {id:"tl4",text:"Quality check — verify team members following standard work at workstation",freq:"Each Shift",timeOfDay:"",duration:"15",owner:"Team Leader",standard:"At least 1 structured observation per shift per zone. Deviations documented and coached — not just fixed.",auditTier:["Supervisor"],timeBin:"Morning"},
  {id:"tl5",text:"5S audit — walk zone and document condition",freq:"Daily",timeOfDay:"",duration:"10",owner:"Team Leader",standard:"Zone meets 5S standard. Items out of place returned or tagged. Score logged on visual board.",auditTier:["Supervisor"],timeBin:"Mid-Shift"},
  {id:"tl6",text:"Problem escalation — issues beyond TL authority raised to Supervisor with data",freq:"As Needed",timeOfDay:"",duration:"",owner:"Team Leader",standard:"Problem described with: what happened, when, how many affected, what TL already tried. Not just 'we have a problem'.",auditTier:[],timeBin:"Mid-Shift"},
  {id:"tl7",text:"Team member feedback — structured coaching against standard (not just correction)",freq:"Daily",timeOfDay:"",duration:"10",owner:"Team Leader",standard:"At least 1 team member receives specific, standard-referenced feedback per shift. Positive and developmental.",auditTier:["Supervisor"],timeBin:"Mid-Shift"},
  {id:"tl8",text:"End of shift handoff — communicate open issues, production status, next shift priorities",freq:"Each Shift",timeOfDay:"End of Shift",duration:"10",owner:"Team Leader",standard:"Incoming TL knows: production status, open issues, any equipment concerns, staffing gaps.",auditTier:["Supervisor"],timeBin:"End of Shift"},
  {id:"tl9",text:"Visual board update — actuals, misses, and actions documented",freq:"Each Shift",timeOfDay:"End of Shift",duration:"10",owner:"Team Leader",standard:"All metrics updated with actuals. Trend visible. Actions have owner and due date.",auditTier:["Supervisor"],timeBin:"End of Shift"},
];
...
async function getAICoaching(context, lang) {
  ...
  try {
    ...
    if(d.error) return lang==="es"?"Coach IA disponible solo dentro de Claude.ai":"AI Coach available inside Claude.ai only — use the Guide tab reflections for coaching prompts";
    return d.content?.[0]?.text||"";
  } catch(e) { return lang==="es"?"Coach IA disponible solo dentro de Claude.ai":"AI Coach available inside Claude.ai only — use the Guide tab reflections for coaching prompts"; }
}
      ...
      <div style={{background:"#080e18",borderBottom:"1px solid #0f1925",padding:"12px 16px"}}>
        <div style={{maxWidth:880,margin:"0 auto",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:10}}>
          ...
          <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
            ...
            <button onClick={handleExport} style={{background:accent+"22",border:`1px solid ${accent}66`,color:accent,borderRadius:6,padding:"7px 14px",cursor:"pointer",fontSize:11,fontWeight:700,fontFamily:"inherit",letterSpacing:1}}>↓ {t.exportLSW} ({LL[activeLevel][lang]})</button>
          </div>
        </div>
      </div>
                        ...
                        return(
                          <div key={r.id} style={{display:"flex",gap:10,padding:"11px 14px",background:"#0f172a",border:`1px solid ${accent}33`,borderRadius:8,marginBottom:6,alignItems:"flex-start"}}>
                            ...
                            <div style={{display:"flex",flexDirection:"column",gap:4,alignItems:"flex-end",flexShrink:0}}>
                              <span style={{fontSize:9,background:r.freq==="Each Shift"||r.freq==="Cada Turno"?accent+"44":accent+"22",color:accent,border:`1px solid ${accent}44`,padding:"2px 7px",borderRadius:3,whiteSpace:"nowrap"}}>{freqBadge}{(r.freq==="Each Shift"||r.freq==="Cada Turno")?" ↻":""}</span>
          ...
          <div className="fade">
            ...
            {tasks.filter(x=>x.disposition).length===0?(
              ...
              ["MAINTAIN","PUSH_DOWN","ELIMINATE","FIREFIGHTING","ESCALATE"].map(key=>{
                ...
                // Firefighting is a cross-cutting concern — show separately, exclude from disposition groups
